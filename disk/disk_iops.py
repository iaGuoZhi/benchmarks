...
csv_filename = f'{work_dir}/disk_iops.csv'
png_filename = f'{work_dir}/disk_iops.png'
...
ax1.legend()
ax1.set_title(f'disk random read iops vs block size')
ax1.set_xlabel('Size')
ax1.set_ylabel('IOPS')
ax1.grid(True)
...
ax2.legend()
ax2.set_title(f'disk random write iops vs block size')
ax2.set_xlabel('Size')
ax2.set_ylabel('IOPS')
ax2.grid(True)
