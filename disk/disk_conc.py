...
csv_filename = f'{work_dir}/disk_conc.csv'
png_filename = f'{work_dir}/disk_conc.png'
...
ax1.legend()
ax1.set_title(f'disk concurrent read throughput vs block size')
ax1.set_xlabel('Size')
...
ax2.legend()
ax2.set_title(f'disk concurrent write throughput vs block size')
ax2.set_xlabel('Size')
