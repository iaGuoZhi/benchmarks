...
# test GFC #
# ================ #
$suncu -o $NCRES/gfc_comp_msg_bt_f64        -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 1 < $DATADIR/msg_bt_f64           > $OUTDIR/msg_bt_f64.gfc           
# $suncu -o $NCRES/gfc_comp_num_brain_f64     -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 1 < $DATADIR/num_brain_f64        > $OUTDIR/num_brain_f64.gfc        
# $suncu -o $NCRES/gfc_comp_num_control_f64   -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 1 < $DATADIR/num_control_f64      > $OUTDIR/num_control_f64.gfc      
# $suncu -o $NCRES/gfc_comp_rsim_f32          -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/rsim_f32             > $OUTDIR/rsim_f32.gfc             
# $suncu -o $NCRES/gfc_comp_turbulence_f32    -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 3 < $DATADIR/turbulence_f32       > $OUTDIR/turbulence_f32.gfc       
# $suncu -o $NCRES/gfc_comp_wave_f32          -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 3 < $DATADIR/wave_f32             > $OUTDIR/wave_f32.gfc             
# $suncu -o $NCRES/gfc_comp_h3d_temp_f32      -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 3 < $DATADIR/h3d_temp_f32         > $OUTDIR/h3d_temp_f32.gfc         
# $suncu -o $NCRES/gfc_comp_citytemp_f32      -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 1 < $DATADIR/citytemp_f32         > $OUTDIR/citytemp_f32.gfc         
# $suncu -o $NCRES/gfc_comp_ts_gas_f32        -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 1 < $DATADIR/ts_gas_f32           > $OUTDIR/ts_gas_f32.gfc           
# $suncu -o $NCRES/gfc_comp_phone_gyro_f64    -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/phone_gyro_f64       > $OUTDIR/phone_gyro_f64.gfc       
# $suncu -o $NCRES/gfc_comp_wesad_chest_f64   -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/wesad_chest_f64      > $OUTDIR/wesad_chest_f64.gfc      
# $suncu -o $NCRES/gfc_comp_solar_wind_f32    -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/solar_wind_f32       > $OUTDIR/solar_wind_f32.gfc       
# $suncu -o $NCRES/gfc_comp_acs_wht_f32       -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/acs_wht_f32          > $OUTDIR/acs_wht_f32.gfc          
# $suncu -o $NCRES/gfc_comp_hdr_night_f32     -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/hdr_night_f32        > $OUTDIR/hdr_night_f32.gfc        
# $suncu -o $NCRES/gfc_comp_hst_wfc3_uvis_f32 -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/hst_wfc3_uvis_f32    > $OUTDIR/hst_wfc3_uvis_f32.gfc    
# $suncu -o $NCRES/gfc_comp_hst_wfc3_ir_f32   -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/hst_wfc3_ir_f32      > $OUTDIR/hst_wfc3_ir_f32.gfc      
# $suncu -o $NCRES/gfc_comp_spitzer_irac_f32  -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/spitzer_irac_f32     > $OUTDIR/spitzer_irac_f32.gfc     
# $suncu -o $NCRES/gfc_comp_jw_mirimage_f32   -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 3 < $DATADIR/jw_mirimage_f32      > $OUTDIR/jw_mirimage_f32.gfc      
# $suncu -o $NCRES/gfc_comp_tpch_order_f64    -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 1 < $DATADIR/tpch_order_f64       > $OUTDIR/tpch_order_f64.gfc       
# $suncu -o $NCRES/gfc_comp_tpcds_catalog_f32 -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/tpcds_catalog_f32    > $OUTDIR/tpcds_catalog_f32.gfc    
# $suncu -o $NCRES/gfc_comp_tpcds_store_f32   -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/tpcds_store_f32      > $OUTDIR/tpcds_store_f32.gfc      
# $suncu -o $NCRES/gfc_comp_tpcds_web_f32     -f --set detailed --section SpeedOfLight_RooflineChart ./GFC 32 32 2 < $DATADIR/tpcds_web_f32        > $OUTDIR/tpcds_web_f32.gfc        
# ================
# test decompress
# ================
