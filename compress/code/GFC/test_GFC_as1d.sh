...
{ ./GFC 32 32 1 < $DATADIR/rsim_f32             > $OUTDIR/rsim_f32.gfc             ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/turbulence_f32       > $OUTDIR/turbulence_f32.gfc       ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/wave_f32             > $OUTDIR/wave_f32.gfc             ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/h3d_temp_f32         > $OUTDIR/h3d_temp_f32.gfc         ; } 2>> $RESDIR/gfc_comp.txt
...
{ ./GFC 32 32 1 < $DATADIR/phone_gyro_f64       > $OUTDIR/phone_gyro_f64.gfc       ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/wesad_chest_f64      > $OUTDIR/wesad_chest_f64.gfc      ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/solar_wind_f32       > $OUTDIR/solar_wind_f32.gfc       ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/acs_wht_f32          > $OUTDIR/acs_wht_f32.gfc          ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/hdr_night_f32        > $OUTDIR/hdr_night_f32.gfc        ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/hst_wfc3_uvis_f32    > $OUTDIR/hst_wfc3_uvis_f32.gfc    ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/hst_wfc3_ir_f32      > $OUTDIR/hst_wfc3_ir_f32.gfc      ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/spitzer_irac_f32     > $OUTDIR/spitzer_irac_f32.gfc     ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/jw_mirimage_f32      > $OUTDIR/jw_mirimage_f32.gfc      ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/tpch_order_f64       > $OUTDIR/tpch_order_f64.gfc       ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/tpcds_catalog_f32    > $OUTDIR/tpcds_catalog_f32.gfc    ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/tpcds_store_f32      > $OUTDIR/tpcds_store_f32.gfc      ; } 2>> $RESDIR/gfc_comp.txt
{ ./GFC 32 32 1 < $DATADIR/tpcds_web_f32        > $OUTDIR/tpcds_web_f32.gfc        ; } 2>> $RESDIR/gfc_comp.txt
# ================
# test decompress
# ================
