...
use log4rs;
use buff::compress::buff_simd::{run_buff_simd_compress32, run_buff_simd_compress64, run_buff_simd_encoding_decoding, run_buff_encoding_decoding_mybitvec, run_buff_majority_encoding_decoding};
...
fn main() {
    ...
    match compression.as_str(){
        ...
        "buff-simd32" => {
            run_buff_simd_compress32(input_file,int_scale,pred);
        },
        "buff-simd64" => {
            run_buff_simd_compress64(input_file,int_scale,pred);
        },
        "buff-slice" => {
